...
def youtubers_detail(request, id):
    tuber_personal = get_object_or_404(Youtuber, pk=id)
    data = {
        'tuber_personal': tuber_personal
    }
...
def search(request):
    ...
    # city_search = Youtuber.objects.all().distinct() Both are same. All will return a list (key value pair). values_list will return 1d array
